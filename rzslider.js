...
.factory('RZSlider', ['$timeout', '$document', 'throttle',
    function($timeout, $document, throttle) {
        ...
        var Slider = function Slider(scope, sliderElem, attributes) {
            /**
             * The slider's scope
             *
             * @type {ngScope}
        ...
        Slider.prototype = {
            ...
            init: function() {
                ...
                angular.element(window)
                    .on('resize', angular.bind(this, this.calcViewDimensions));
            ...
            calcViewDimensions: function() {
                ...
                this.sliderElem.rzsl = this.sliderElem[0].getBoundingClientRect()
                    .left;
